...
class Base():
    ...
    def create_grafana_datasource(
        ...
        Returns:
            boolean -- The status of the request. 'True'
            with the request was successful, 'False' otherwise
        """
    ...
    def create_grafana_dashboard(
        ...
        Arguments:
            user {string} -- Grafana's user with the necessary permissions
            password {string} -- Password of the Grafana user
            visualizer_ip {string} -- IP of one of the slaves
            that will be used to access the visualizer
